...
Измерить с помощью MPI_Wtime() время исполнения на 4, 8, 16 и 28 узлах. 

Непараллельный алгоритм интегрирования для случая, когда количество шагов пользователь вводит с клавиатуры есть в папке /tmp/54x/integral (см файл int.c). 

Для автоматического тестирования вашего кода вам нужно:

#. Скопировать к себе в папку /tmp/54x/integral вместе со всем содержимым. 
#. Написать свой распараллеленный код в файле tint.c (это важно, чтоб название было именно таким!)
#. Запустить скрипт check.sh
#. Следить за увлекательным процессом тестирования.
